...
class NutiFilter extends StatefulWidget {
  const NutiFilter({Key? key}) : super(key: key);

  @override
  State<NutiFilter> createState() => _NutiFilterState();
}

class _NutiFilterState extends State<NutiFilter> {
                              ...
                              child: Padding(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Center(child: Text("Premium Pickles",
